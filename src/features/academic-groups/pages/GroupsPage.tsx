...
import { Outlet, useNavigate, useParams, Link } from "@tanstack/react-router"
...
export function GroupsPage() {
    const { projectId: carreraId } = useParams({ from: '/projects/$projectId/groups' })
    ...
    return (
        <div className="space-y-8 animate-in fade-in duration-500">
            ...
            {/* Cuando la URL es /projects/:projectId/groups/:groupId, aquí se pinta el detalle del grupo */}
            <Outlet />
        </div>
    )
}
