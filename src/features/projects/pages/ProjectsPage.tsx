...
const CARD_VARIANTS = [
  ...
  {
    icon: (cls: string) => <BriefcaseMedical className={cls} />,
    color: "bg-blue-50",
  },
  {
    icon: (cls: string) => <LineChart className={cls} />,
    color: "bg-emerald-50",
  },
  { icon: (cls: string) => <Cpu className={cls} />, color: "bg-orange-50/70" },
  { icon: (cls: string) => <Wifi className={cls} />, color: "bg-cyan-50/70" },
  {
    icon: (cls: string) => <GraduationCap className={cls} />,
    color: "bg-purple-50",
  },
  {
    icon: (cls: string) => <FlaskConical className={cls} />,
    color: "bg-rose-50",
  },
  {
    icon: (cls: string) => <Building2 className={cls} />,
    color: "bg-yellow-50",
  },
